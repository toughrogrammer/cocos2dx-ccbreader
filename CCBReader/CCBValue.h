...
class ccColor4BWapper : public CCObject
{
private:
    ccColor4B color;
    
public:
    static ccColor4BWapper* create(const ccColor4B& color);
    
    const ccColor4B& getColor() const;
};

class ccColor4FWrapper : public CCObject
{
private:
	ccColor4F color;

public:
	static ccColor4FWrapper* create( const ccColor4F& color );
	const ccColor4F& getColor() const;
};
